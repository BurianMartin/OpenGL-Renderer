...
namespace Core
{
    ...
    {
        /// Current active camera's view matrix, refreshed once per frame by Scene::UpdateRenderContext().
        glm::mat4 view_;
        /// Current active camera's projection matrix, refreshed once per frame by Scene::UpdateRenderContext().
