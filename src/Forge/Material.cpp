...
namespace Forge
{
    ...
    {
        return Create(shader, "Gold", {0.24725f, 0.1995f, 0.0745f}, {0.75164f, 0.60648f, 0.22648f}, {0.628281f, 0.555802f, 0.366065f}, 51.2f);
    }

    std::shared_ptr<Material> Material::Silver(std::shared_ptr<Shader> shader)
    {
        return Create(shader, "Silver", {0.19225f, 0.19225f, 0.19225f}, {0.50754f, 0.50754f, 0.50754f}, {0.508273f, 0.508273f, 0.508273f}, 51.2f);
    }

    std::shared_ptr<Material> Material::Bronze(std::shared_ptr<Shader> shader)
    {
        return Create(shader, "Bronze", {0.2125f, 0.1275f, 0.054f}, {0.714f, 0.4284f, 0.18144f}, {0.393548f, 0.271906f, 0.166721f}, 25.6f);
    }

    std::shared_ptr<Material> Material::Chrome(std::shared_ptr<Shader> shader)
    {
        return Create(shader, "Chrome", {0.25f, 0.25f, 0.25f}, {0.4f, 0.4f, 0.4f}, {0.774597f, 0.774597f, 0.774597f}, 76.8f);
    }

    std::shared_ptr<Material> Material::Emerald(std::shared_ptr<Shader> shader)
    {
        return Create(shader, "Emerald", {0.0215f, 0.1745f, 0.0215f}, {0.07568f, 0.61424f, 0.07568f}, {0.633f, 0.727811f, 0.633f}, 76.8f);
    }

    std::shared_ptr<Material> Material::Ruby(std::shared_ptr<Shader> shader)
    {
        return Create(shader, "Ruby", {0.1745f, 0.01175f, 0.01175f}, {0.61424f, 0.04136f, 0.04136f}, {0.727811f, 0.626959f, 0.626959f}, 76.8f);
    }

    std::shared_ptr<Material> Material::Pearl(std::shared_ptr<Shader> shader)
    {
        return Create(shader, "Pearl", {0.25f, 0.20725f, 0.20725f}, {1.0f, 0.829f, 0.829f}, {0.296648f, 0.296648f, 0.296648f}, 11.264f);
    }

    std::shared_ptr<Material> Material::Obsidian(std::shared_ptr<Shader> shader)
    {
        return Create(shader, "Obsidian", {0.05375f, 0.05f, 0.06625f}, {0.18275f, 0.17f, 0.22525f}, {0.332741f, 0.328634f, 0.346435f}, 38.4f);
    }

    std::shared_ptr<Material> Material::Light(std::shared_ptr<Shader> shader)
    {
        return Create(shader, "Light", {0.1f, 0.1f, 0.1f}, {0.8f, 0.8f, 0.8f}, {1.0f, 1.0f, 1.0f}, 128.0f);
    }

    std::shared_ptr<Material> Material::Copper(std::shared_ptr<Shader> shader)
    {
        return Create(shader, "Copper", {0.19125f, 0.0735f, 0.0225f}, {0.7038f, 0.27048f, 0.0828f}, {0.256777f, 0.137622f, 0.086014f}, 12.8f);
    }
    ...
    std::shared_ptr<Shader> Forge::Material::GetShader() const
    {
        return shader_;
    }
} // namespace Forge
